...
main()
{
	...
	while(true) {
		...
		if (valor%2 == 0) {
			if (contagem_par >= 12) {
				printf("Não podem ser inseridos mais que 12 valores pares! Insira um valor ímpar.\n");
			}
			else {
			...
			if (contagem_impar >= 8) {
				printf("Não podem ser inseridos mais que 08 valores ímpares! Insira um valor par.\n");
			}
			else {
